...
public class Script
{
	...
	public void InitializeCustomCode()
	{
		...
		this.edvUD004 = ((EpiDataView)(this.oTrans.EpiDataViews["UD04"]));
	...
	private void oTrans_adapter_AfterAdapterMethod(object sender, AfterAdapterMethodArgs args)
	{
		...
		{
			case "Update":
				DataRow currentRow = this.edvUD004.CurrentDataRow;
				currentRow["TargetNumber_c"] = currentRow["Key1"];
				//MessageBox.Show(currentRow["Key1"].ToString());
				break;
		}
